    ...
    internal class Crc32
    {
        ...
        static Crc32()
        {
            crc_32_tab = new uint[]
            {
                ...
                1256170817, 1037604311, 2765210733, 3554079995, 1131014506, 879679996, 2909243462, 3663771856,
                ...
                3654703836, 1088359270, 936918000, 2847714899, 3736837829, 1202900863, 817233897, 3183342108, 3401237130,
                1404277552, 615818150, 3134207493, 3453421203, 1423857449, 601450431, 3009837614, 3294710456, 1567103746,
        ...
        public static uint CRC32String(string text)
        {
            ...
            {
                len--;
                ushort uCharVal = text[len];
                byte lowByte = (byte) (uCharVal & 255);
                byte hiByte = (byte) (uCharVal >> 8);
        ...
        {
            return crc_32_tab[(crc ^ octet) & 255] ^ crc >> 8;
        }
    }
}