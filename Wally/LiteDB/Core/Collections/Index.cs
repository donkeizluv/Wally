...
namespace LiteDB
{
    internal partial class LiteCollection<T>
    {
        ...
        {
            return EnsureIndex(field, new IndexOptions {Unique = unique});
        }
        ...
        {
            string field = _visitor.GetBsonField(property);
        ...
        public bool EnsureIndex<K>(Expression<Func<T, K>> property, IndexOptions options)
        {
            ...
            return EnsureIndex(field, options);
        }
        ...
        {
            return _engine.GetIndexes(Name);
        }
        ...
        public bool DropIndex(string field)
        {
            ...
            return _engine.DropIndex(Name, field);
        }
    }
}