...
namespace LiteDB
{
    ...
    internal class QueryVisitor<T>
    {
        ...
        {
            int length = queries.Length - startIndex;
            if (length == 0)
