...
namespace LiteDB
{
    ...
    /// </summary>
    internal class ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>
    {
        /// <summary>
        ...
        {
            string hostName = Environment.MachineName; // use instead of Dns.HostName so it will work offline
        ...
        public static ObjectId NewObjectId()
        {
            ...
            int inc = Interlocked.Increment(ref _increment) & 0x00ffffff;
