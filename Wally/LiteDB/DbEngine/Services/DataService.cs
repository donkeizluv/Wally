...
namespace LiteDB
{
    internal class DataService
    {
        ...
        public DataBlock Insert(CollectionPage col, byte[] data)
        {
            ...
            bool extend = data.Length + DataBlock.DATA_BLOCK_FIXED_SIZE > BasePage.PAGE_AVAILABLE_BYTES;
        ...
        public DataBlock Update(CollectionPage col, PageAddress blockAddress, byte[] data)
        {
            ...
            bool extend = dataPage.FreeBytes + block.Data.Length - data.Length <= 0;
        ...
        public void StoreExtendData(ExtendPage page, byte[] data)
        {
            ...
            while (bytesLeft > 0)
            {
                int bytesToCopy = Math.Min(bytesLeft, BasePage.PAGE_AVAILABLE_BYTES);
